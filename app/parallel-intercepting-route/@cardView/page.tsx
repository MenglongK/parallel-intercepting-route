...
export default function page() {
  return (
    <>
      <h3 id="cardView" className="md:text-4xl text-2xl text-center backdrop-blur-md bg-white/25 text-white font-semibold px-8 py-4 rounded-full border border-white/40 shadow-xl hover:shadow-2xl md:mx-30 lg:mx-80 mx-10">
        Card View
      </h3>
